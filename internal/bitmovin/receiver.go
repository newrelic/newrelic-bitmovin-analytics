...
func setupReceivers(
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_cnt_max_concurrent_viewers",
		&MaxConcurrentViewersQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_avg_rebuffer_percentage",
		&RebufferPercentageQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_cnt_play_attempts",
		&PlayerAttemptsQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_cnt_video_start_failures",
		&VideoStartFailsQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_avg_video_startup_time_ms",
		&VideoStartTimeQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_avg_video_bitrate_mbps",
		&VideoBitrateQueryParams,
	)
	...
	addReceiver(
		...
		metricPrefix,
		recvInterval,
		"bitmovin_avg_view_time",
		&AverageViewTimeQueryParams,
	)
	*/
}
